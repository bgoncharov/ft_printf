...
#    Updated: 2019/03/31 20:24:56 by bogoncha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_printf.c parser.c char_string.c numbers.c main.c

OBJS = ft_printf.o parser.o char_string.o numbers.o main.o
